 ...
 */
// unedited src https://cdn.datatables.net/1.13.1/js/dataTables.bootstrap5.min.js
! function(t) {
	...
	return x.extend(!0, o.defaults, {
		dom: "<'row'<'col-sm-12 col-md-6 pb-2'l><'col-sm-12 col-md-6 pb-2'f>><'row dt-row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 pt-3'p>>",
		renderer: "bootstrap"
	}), x.extend(o.ext.classes, {
		sWrapper: "dataTables_wrapper dt-bootstrap5",
		sFilterInput: "form-control form-control-sm searchBar",
